...
config.gen.namesOnly = !!args.names
config.gen.stepsUniq = +(args.uniq || 0);
config.gen.testsLimit = +(args.limitTests || 1000000);
config.gen.stepsLimit = +(args.limitSteps || Infinity);
